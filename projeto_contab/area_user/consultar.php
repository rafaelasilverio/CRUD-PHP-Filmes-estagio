...
<html>
    ...
    <body>
        <div style="position: absolute; height: 116px; top: 35%; width: 100%; left: 0;">
            <div style="position: relative; height: 116px; top: -58px;">
                <div class="container">
                    <form action="processa_consulta.php" method="POST">
                        <fieldset class="form-group border p-3">
                            <legend class="display-6">Consultar filme</legend><br>
                            <label class="form-label">Informe o código do filme que deseja consultar:</label><br>
                            <input type="number" class="form-control" name="codigo_filme" placeholder="Ex: 3 " required><br>
                            <div class="d-grid gap-2 d-md-block">
                                <button type="submit" class="btn btn-success" name="editar" value ="editar">Consultar</button>
